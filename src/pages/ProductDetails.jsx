...
const product = {
  name: 'Adria Fabric RHS Chaise Lounger in Bold Yellow Colour',
  price: '₹15,899',
  href: '#',
  breadcrumbs: [
    { id: 1, name: 'Sofas', href: '#' }
  ],
  images: [
    {
    ...
    },
    {
      ...
      alt: 'Adria Fabric RHS Chaise Lounger in Bold Yellow Colour',
    },
  ],
  colors: [
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <form className="mt-10">
              ...
              <button
                type="submit"
                className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-orange-600 px-8 py-3 text-base font-medium text-white hover:bg-red-600"
              >
                Add to Cart
              </button>
            </form>
